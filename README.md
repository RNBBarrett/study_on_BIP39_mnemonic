...
Calculate the 12th binary number:
---------------------------------
...
binary_bytes = bytes(random_binary, 'utf-8')

# Compute the SHA-256 hash
sha256_hash = hashlib.sha256(binary_bytes)
...
print(hex_digest)
```
This results in the following SHA-256 hash of our original number:

<img width="463" alt="Screenshot 2023-05-06 at 1 51 18 PM" src="https://user-images.githubusercontent.com/46794084/236639399-30a55080-fe49-414c-b195-0c93baa14aa9.png">

Sub-step 4.b Convert first character of sha-256 hash to binary
---------------------------------------------------------------

The sha-256 hash algorithm resulted in the hexadecimal number:
1a87be1fb6fcce70a5ceabbbec69a65b640ecab1230d74495523a1c334b5657d

Taking the first character "1" we convert this back to binary: 
